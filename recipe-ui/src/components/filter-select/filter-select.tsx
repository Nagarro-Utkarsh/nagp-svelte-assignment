...
export class FilterSelect {
  ...
  @Event({ eventName: "filter-change" })
  filterChange!: EventEmitter<FilterChangeDetail>;
  ...
  componentDidRender() {
    ...
    const active = this.listEl?.children[this.activeIndex] as
  ...
  private get visible() {
    ...
    if (term)
      return this.all.filter((option) => option.toLowerCase().includes(term));
